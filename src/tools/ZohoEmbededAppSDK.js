        ...
        if (e) f = d
          ...
          if (c) {
            var x,
              k = []
            for (x in c)
              k.push(encodeURIComponent(x) + "\x3d" + encodeURIComponent(c[x]))
            x = k.join("\x26")
            f += (-1 < f.indexOf("?") ? "\x26" : "?") + x
          }
          f = {
        ...
        API: {
          ...
          getApprovalRecords: function(a) {
            ...
            a
              ...
              : ((d.action = "GET_APPROVAL_RECORDS"), (a = d))
            return h(a)
          },
...
var ZSDKUtil = (function(c) {
  ...
  ZSDKMessageManager = (function(c) {
    ...
    function m(a, b, d) {
      k.hasOwnProperty(a) &&
        (b ? k[a].resolve(d) : k[a].reject(d), (k[a] = void 0), delete k[a])
    }
    function y(a) {
